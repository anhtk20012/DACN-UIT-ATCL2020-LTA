...
def get_node_edges(filepath: str, verbose=0):
    ...
    # edges.to_csv("/home/ubuntu/linevd/sastvd/helpers/test1.csv", index=False)
    ...
    # nodes.to_csv("/home/ubuntu/linevd/sastvd/helpers/test1.csv", index=False)
    ...
    # nodes.to_csv("/home/ubuntu/linevd/sastvd/helpers/test1.csv", index=False)
    # edges.to_csv("/home/ubuntu/linevd/sastvd/helpers/test2.csv", index=False)
    # print(type(nodes["id"][0]))
