...
from dgl.dataloading import GraphDataLoader, DataLoader, MultiLayerFullNeighborSampler
...
class BigVulDatasetLineVDDataModule(pl.LightningDataModule):
    ...
    def node_dl(self, g, shuffle=False):
        ...
        sampler = MultiLayerFullNeighborSampler(self.nsampling_hops)
    ...
    def val_graph_dataloader(self):
        ...
        graphdataloader = GraphDataLoader(self.val, batch_size=32)
        return graphdataloader

    def test_dataloader(self):
        """Return test dataloader."""
        graphdataloader = GraphDataLoader(self.test, batch_size=32)
        return graphdataloader
...
class LitGNN(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        result = [logits[0], logits_f], [labels, labels_f], preds
    ...
    def on_test_epoch_end(self): #, outputs):
        ...
        multitask_true = th.tensor(multitask_true).long()
